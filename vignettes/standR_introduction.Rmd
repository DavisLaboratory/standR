...
spe <- readGeoMx(dirPath, countFile, sampleAnnoFile, featureAnnoFile = featureAnnoFile, hasNegProbe = TRUE)
...
```{r}
plotPairPCA(spe_tmm, assay = 2, n_dimension = 4, color = disease_status, shape = regions)
```
